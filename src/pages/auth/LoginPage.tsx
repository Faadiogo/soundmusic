    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-500 to-gray-400 flex justify-center items-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white rounded-lg shadow-xl overflow-hidden">
        <div className="px-6 py-8 sm:px-10 sm:py-12">
          ...
          <h2 className="text-center text-2xl font-bold text-gray-900 mb-8">Entrar na sua conta</h2>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-yellow-500 focus:ring-primary-500 border-gray-300 rounded"
                />
